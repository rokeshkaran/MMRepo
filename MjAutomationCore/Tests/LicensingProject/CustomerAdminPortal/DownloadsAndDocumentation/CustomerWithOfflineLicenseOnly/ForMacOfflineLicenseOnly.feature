@retry(2)
Feature: ForMacOfflineLicenseOnly
...
Scenario Outline: Verify_Installers_for_Mac_with_offline_licenses_only
...
Scenario Outline: Verify_documentation_links_for_Mac_with_offline_licenses_only
...
@Licensing @CustomerAdminPortal @DownloadsANDDocumentation @OfflineLicense @QA @Staging @Qase[LICENSE-490] @Cleanup
Scenario Outline: To_verify_that_it_is_possible_to_download_Installer_for_Mac_offline
...
@Licensing @CustomerAdminPortal @DownloadsANDDocumentation @OfflineLicense @QA @Staging @Qase[LICENSE-518] @Cleanup
Scenario Outline: To_verify_that_it_is_possible_to_open_MindManager_Mac_Release_Notes_offline
...
@Licensing @CustomerAdminPortal @DownloadsANDDocumentation @OfflineLicense @QA @Staging @Qase[LICENSE-533] @Cleanup
Scenario Outline: To_verify_that_it_is_possible_to_open_Online_help_from_Mac_section_offline
