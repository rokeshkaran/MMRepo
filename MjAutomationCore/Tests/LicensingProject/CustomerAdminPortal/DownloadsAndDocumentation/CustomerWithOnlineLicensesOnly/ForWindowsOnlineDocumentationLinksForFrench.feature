@retry(2)
Feature: ForWindowsOnlineDocumentationLinksForFrench
...
@Licensing @CustomerAdminPortal @DownloadsANDDocumentation @OnlineLicense @QA @Staging @Qase[LICENSE-525] @Locale_French @Cleanup
Scenario: To_verify_that_it_is_possible_to_open_User_guide_and_online_help_online_Locale_French
...
@Licensing @CustomerAdminPortal @DownloadsANDDocumentation @OnlineLicense @QA @Staging @Qase[LICENSE-531] @Locale_French @Cleanup
Scenario: To_verify_that_it_is_possible_to_open_End_user_language_selection_instructions_online_Locale_French
...
@Licensing @CustomerAdminPortal @DownloadsANDDocumentation @OnlineLicense @QA @Staging @Qase[LICENSE-512] @Locale_French @Cleanup
Scenario: To_verify_that_it_is_possible_to_open_MindManager_Windows_Release_Notes_online_Locale_French
