@retry(2)
Feature: ForMacOnlineDocumentationLinksForFrench
...
@Licensing @CustomerAdminPortal @DownloadsANDDocumentation @OnlineLicense @QA @Staging @Qase[LICENSE-534] @Locale_French @Cleanup
Scenario Outline: To_verify_that_it_is_possible_to_open_Online_help_from_Mac_section_online_Locale_French
...
@Licensing @CustomerAdminPortal @DownloadsANDDocumentation @OnlineLicense @QA @Staging @Qase[LICENSE-513] @Locale_French @Cleanup
Scenario Outline: To_verify_that_it_is_possible_to_open_MindManager_Mac_Release_Notes_online_Locale_French
