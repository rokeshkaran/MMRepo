@retry(2)
Feature: ForMacOnlineAndOfflineDocumentationLinksForGerman
...
@Licensing @CustomerAdminPortal @DownloadsANDDocumentation @OnlineANDOfflineLicenses @QA @Staging @Qase[LICENSE-508] @Locale_German @Cleanup
Scenario: To_verify_that_it_is_possible_to_open_MindManager_Mac_Release_Notes_with_both_onlineANDoffline_licenses_Locale_German
