@retry(2)
Feature: ForWindowsOnlineAndOfflineLicenses
...
Scenario Outline: Verify_Installers_for_Windows_with_both_onlineANDoffline_licenses
...
@Licensing @CustomerAdminPortal @DownloadsANDDocumentation @OnlineANDOfflineLicenses @QA @Staging @Qase[LICENSE-483] @Cleanup
Scenario Outline: Verify_documentation_links_for_Windows_with_both_onlineANDoffline_licenses
...
@Licensing @CustomerAdminPortal @DownloadsANDDocumentation @OnlineANDOfflineLicenses @QA @Staging @Qase[LICENSE-465] @Cleanup
Scenario: To_verify_that_it_is_possible_to_download_self_installer_of_Windows_with_both_onlineANDoffline_licenses
...
@Licensing @CustomerAdminPortal @DownloadsANDDocumentation @OnlineANDOfflineLicenses @QA @Staging @Qase[LICENSE-467] @Cleanup
Scenario: To_verify_that_it_is_possible_to_download_Admin_Setup_32_bit_for_Windows_with_both_onlineANDoffline_licenses
...
@Licensing @CustomerAdminPortal @DownloadsANDDocumentation @OnlineANDOfflineLicenses @QA @Staging @Qase[LICENSE-468] @Cleanup
Scenario: To_verify_that_it_is_possible_to_download_Admin_Setup_32_bit_for_Windows_offline_with_both_onlineANDoffline_licenses
...
@Licensing @CustomerAdminPortal @DownloadsANDDocumentation @OnlineANDOfflineLicenses @QA @Staging @Qase[LICENSE-469] @Cleanup
Scenario: To_verify_that_it_is_possible_to_download_Admin_Setup_64_bit_for_Windows_with_both_onlineANDoffline_licenses
...
@Licensing @CustomerAdminPortal @DownloadsANDDocumentation @OnlineANDOfflineLicenses @QA @Staging @Qase[LICENSE-470] @Cleanup
Scenario: To_verify_that_it_is_possible_to_download_Admin_Setup_64_bit_for_Windows_offline_with_both_onlineANDoffline_licenses
...
@Licensing @CustomerAdminPortal @DownloadsANDDocumentation @OnlineANDOfflineLicenses @QA @Staging @Qase[LICENSE-527] @Cleanup
Scenario: To_verify_that_it_is_possible_to_open_MindManager_Windows_Release_Notes_with_both_onlineANDoffline_licenses
...
@Licensing @CustomerAdminPortal @DownloadsANDDocumentation @OnlineANDOfflineLicenses @QA @Staging @Qase[LICENSE-530] @Cleanup
Scenario: To_verify_that_it_is_possible_to_open_User_guide_and_online_help_with_both_onlineANDoffline_licenses
...
@Licensing @CustomerAdminPortal @DownloadsANDDocumentation @OnlineANDOfflineLicenses @QA @Staging @Qase[LICENSE-524] @Cleanup
Scenario: To_verify_that_it_is_possible_to_open_End_user_language_selection_instructions_with_both_onlineANDoffline_licenses
...
@Licensing @CustomerAdminPortal @DownloadsANDDocumentation @OnlineANDOfflineLicenses @QA @Staging @Qase[LICENSE-511] @Cleanup
Scenario: To_verify_that_it_is_possible_to_open_Migration_Guide_with_both_onlineANDoffline_licenses
