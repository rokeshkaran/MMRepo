@retry(2)
Feature: ForMindManagerWebOnlineAndOfflineLicenses
...
Scenario Outline: Verify_Installers_for_MindManager_Web_with_both_onlineANDoffline_licenses
...
@Licensing @CustomerAdminPortal @DownloadsANDDocumentation @OnlineANDOfflineLicenses @QA @Staging @Qase[LICENSE-483] @Cleanup
Scenario Outline: Verify_documentation_links_for_MindManager_Web_with_both_onlineANDoffline_licenses
...
@Licensing @CustomerAdminPortal @DownloadsANDDocumentation @OnlineANDOfflineLicenses @QA @Staging @Qase[LICENSE-492] @Cleanup
Scenario Outline: To_verify_that_it_is_possible_to_log_in_to_Web_app_with_both_onlineANDoffline_licenses
...
@Licensing @CustomerAdminPortal @DownloadsANDDocumentation @OnlineANDOfflineLicenses @QA @Staging @Qase[LICENSE-521] @Cleanup
Scenario: To_verify_that_it_is_possible_to_open_MindManager_Web_Release_Notes_with_both_onlineANDoffline_licenses
