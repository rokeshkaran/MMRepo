@retry(2)
Feature: ForWindowsOnlineAndOfflineDocumentationLinksForFrench
...
@Licensing @CustomerAdminPortal @DownloadsANDDocumentation @OnlineANDOfflineLicenses @QA @Staging @Qase[LICENSE-524] @Locale_French @Cleanup
Scenario: To_verify_that_it_is_possible_to_open_End_user_language_selection_instructions_with_both_onlineANDoffline_licenses_Locale_French
