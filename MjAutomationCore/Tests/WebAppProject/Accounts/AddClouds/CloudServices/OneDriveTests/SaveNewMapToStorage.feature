...
@MindManager @Cloud_Services @OneDrive @App_QA @App_Staging @App_Prod @Cleanup @Qase[WEB-1523] @Upd_Qase
Scenario: To_verify_that_new_map_can_be_saved_to_OneDrive
	...
	When User clicks button with  text 'OneDrive' and subtext 'auto.test@mindmanagercloudqa.com' in 'save-to' menu
	...
	Then Web Editor page is displayed to the User
	Then item with Path 'For QA automation/RuntimeData File/new_map_SRND.mmap' exists in OneDrive cloud via Api