...
@MindManager @Cloud_Services @Box @SaveNewMap @App_QA @App_Staging @App_Prod @Cleanup @Qase[WEB-1521] @Upd_Qase @JIRA[MMCV-9836]
Scenario: To_verify_that_new_map_can_be_saved_to_Box
	...
	When User clicks button with 'Box' name in 'save-to' menu
	...
	Then Web Editor page is displayed to the User
	Then file 'new_map_SRND.mmap' exists in 'RuntimeDataFiles' folder in Box cloud via Api