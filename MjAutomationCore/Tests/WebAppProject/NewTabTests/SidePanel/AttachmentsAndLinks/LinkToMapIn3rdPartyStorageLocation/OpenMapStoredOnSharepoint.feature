@retry(2)
Feature: OpenMapStoredOnSharepoint
...
@MindManager @Attachments_Links @Link_to_map_that_is_in_3rd_party_storage_location @OpenMapStoredOnSharepoint @App_QA @App_Staging @App_Prod @Cleanup @Qase[WEB-821] @Upd_Qase
Scenario: To_verify_that_user_can_open_Sharepoint_map_by_attached_link_with_edit_permission
	When User login to SharePoint cloud
	When User opens 'auto_test_SRND.mmap' Mind Manager File in browser
	Then Web Editor page is displayed to the User
	When User clicks Hyperlinks icon in 'Link to SharePoint map in Milan site' topic infobox
...
@MindManager @Attachments_Links @Link_to_map_that_is_in_3rd_party_storage_location @OpenMapStoredOnSharepoint @App_QA @App_Staging @App_Prod @Cleanup @Qase[WEB-822] @Upd_Qase
Scenario: To_verify_that_user_can_open_Sharepoint_map_by_attached_link_with_view_only_permission
	When User login to SharePoint cloud with all sites
	When User opens 'auto_test_SRND.mmap' Mind Manager File in browser
	Then Web Editor page is displayed to the User
	When User clicks Hyperlinks icon in 'Link to SharePoint read-only map' topic infobox
	Then '2' count tab is open in browser
	When User switches to '1' tab
	Then Web Editor page is displayed to the User
	When User clicks 'Central Topic' topic on Canvas
...
@MindManager @Attachments_Links @Link_to_map_that_is_in_3rd_party_storage_location @OpenMapStoredOnSharepoint @App_QA @App_Staging @App_Prod @Cleanup @Qase[WEB-823] @Upd_Qase
Scenario: To_verify_that_user_can_open_Sharepoint_map_by_attached_link_without_permission
	When User opens 'auto_test_SRND.mmap' Mind Manager File in browser
	Then Web Editor page is displayed to the User
	When User clicks Hyperlinks icon in 'Link to SharePoint map (no permissions)' topic infobox
	Then '2' count tab is open in browser
	When User switches to '1' tab
...
@MindManager @Attachments_Links @Link_to_map_that_is_in_3rd_party_storage_location @OpenMapStoredOnSharepoint @App_QA @App_Staging @App_Prod @Cleanup @Qase[WEB-824] @Upd_Qase
Scenario: To_verify_that_user_can_open_Sharepoint_map_by_attached_link_with_login_to_cloud
...
@MindManager @Attachments_Links @Link_to_map_that_is_in_3rd_party_storage_location @OpenMapStoredOnSharepoint @Co_Editing @App_QA @App_Staging @App_Prod @Cleanup @Qase[WEB-825] @Upd_Qase
Scenario: To_verify_that_user_can_open_Sharepoint_map_by_attached_link_in_coedit_session
