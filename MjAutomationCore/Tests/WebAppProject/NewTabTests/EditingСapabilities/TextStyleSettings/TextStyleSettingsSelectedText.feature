@retry(2)
Feature: TextStyleSettingsSelectedText
Check functionality context menu for Text style settings applies to the selected text
...
Scenario: Check_that_Font_style_can_be_applied_all_of_topic_text
	When User clicks 'Text Formatting' topic on Canvas
	When User triple clicks to the 'Text Formatting' topic text on Canvas
...
@MindManager @EditingCapabilities @TextStyleSettings @App_QA @App_Staging @App_Prod @Cleanup @Qase[WEB-268] @Upd_Qase
Scenario: Check_that_Font_style_can_be_applied_to_part_of_topic_text
	When User remembers 'Text Formatting' topic model id and name
	When User clicks 'Text Formatting' topic on Canvas
	When User clicks on text in the 'Text Formatting' topic on Canvas
	Then text editor is displayed in 'TextEditorPopup' container
	When User presses the 'Home' key on the keyboard
	When User selects from `0` to '4' the text symbol in 'Text Formatting' topic
	When User clicks font family section in text editor and selects 'Impact' option in 'font-family' selectbox in 'TextEditorPopup' container
	Then text 'Text' is displayed in 'Impact' font in the 'Text Formatting' topic on Canvas
	Then text 'Formatting' is displayed in 'Segoe UI' font in the 'Text Formatting' topic on Canvas
	Then text 'Formatting' is displayed in 'Source Sans Pro' font in the 'Text Formatting' topic on Canvas

@MindManager @EditingCapabilities @TextStyleSettings @App_QA @App_Staging @App_Prod @Cleanup @Qase[WEB-268] @Upd_Qase
Scenario: Check_that_Font_style_can_be_applied_to_part_of_multiline_topic_text
	When User remembers 'Multiline topic text' topic model id and name
	When User clicks 'Multiline topic text' topic on Canvas
	When User clicks on text in the 'Multiline topic text' topic on Canvas
	Then text editor is displayed in 'TextEditorPopup' container
	When User presses the 'Home' key on the keyboard
	...
	Then text 'Topic for a specific' is displayed in 'Segoe UI' font in the 'Multiline topic text' topic on Canvas
	Then text 'Text formatting test' is displayed in 'Segoe UI' font in the 'Multiline topic text' topic on Canvas

@MindManager @EditingCapabilities @TextStyleSettings @App_QA @App_Staging @App_Prod @Cleanup @Qase[WEB-269] @Upd_Qase @JIRA[MMCV-9794]
Scenario: Check_that_Font_Size_can_be_applied_all_of_topic_text
	When User clicks 'Text Formatting' topic on Canvas
	When User clicks on text in the 'Text Formatting' topic on Canvas
	Then text editor is displayed in 'TextEditorPopup' container
...
Scenario: Check_that_Font_Size_can_be_applied_to_part_of_topic_text
	When User remembers 'Text Formatting' topic model id and name
	When User clicks 'Text Formatting' topic on Canvas
	When User clicks on text in the 'Text Formatting' topic on Canvas
	Then text editor is displayed in 'TextEditorPopup' container
	...
	When User clicks by coordinates '200' and '50' on Canvas
	Then text 'Text' has font size of '34.666' in the 'Text Formatting' topic on Canvas
	Then text 'Formatting' has font size of '16' in the 'Text Formatting' topic on Canvas

@MindManager @EditingCapabilities @TextStyleSettings @App_QA @Cleanup @Qase[WEB-269] @Upd_Qase
Scenario: Check_that_Font_Size_can_be_applied_to_part_of_multiline_topic_text
	When User remembers 'Multiline topic text' topic model id and name
	When User clicks 'Multiline topic text' topic on Canvas
	When User clicks on text in the 'Multiline topic text' topic on Canvas
	Then text editor is displayed in 'TextEditorPopup' container
	...
	Then text 'Topic for a specific' has font size of '13.333' in the 'Multiline topic text' topic on Canvas
	Then text 'Text formatting test' has font size of '13.333' in the 'Multiline topic text' topic on Canvas

@MindManager @EditingCapabilities @TextStyleSettings @App_QA @App_Staging @App_Prod @Cleanup @Qase[WEB-270] @Upd_Qase
Scenario: Check_that_color_can_be_applied_to_all_of_topic_text_by_enter_hex_code
	When User remembers 'Text Formatting' topic model id and name
	When User clicks 'Text Formatting' topic on Canvas
	When User clicks on text in the 'Text Formatting' topic on Canvas
	Then text editor is displayed in 'TextEditorPopup' container
...
@MindManager @EditingCapabilities @TextStyleSettings @App_QA @App_Staging @App_Prod @Cleanup @Qase[WEB-270] @Upd_Qase
Scenario: Check_that_color_can_be_applied_to_part_of_topic_text_by_enter_hex_code
	When User remembers 'Text Formatting' topic model id and name
	When User clicks 'Text Formatting' topic on Canvas
	When User clicks on text in the 'Text Formatting' topic on Canvas
	Then text editor is displayed in 'TextEditorPopup' container
	...
	When User clicks Color button in text editor in 'TextEditorPopup' container
	Then Color Picker window is displayed to User
	When User enters '#ff6c4192' hex code in input field on Color picker
	When User presses the 'Enter' key on the keyboard
	Then Color Preview has color 'rgb(108, 65, 146)' on Color Picker
	When User clicks 'Apply' button in Color Picker window
	When User clicks by coordinates '200' and '50' on Canvas
	Then text 'Text' has 'rgba(108, 65, 146, 1)' color in the 'Text Formatting' topic on Canvas
	Then text 'Formatting' has 'rgba(0, 0, 0, 1)' color in the 'Text Formatting' topic on Canvas

@MindManager @EditingCapabilities @TextStyleSettings @App_QA @App_Staging @App_Prod @Cleanup @Not_Run_Edge @Qase[WEB-270] @Upd_Qase
Scenario: Check_that_color_can_be_applied_to_part_of_topic_text_by_clicking_on_color_Slider_not_edge
	When User remembers 'Text Formatting' topic model id and name
	When User remembers 'Text' text color in 'Text Formatting' topic on Canvas
	When User clicks 'Text Formatting' topic on Canvas
	When User clicks on text in the 'Text Formatting' topic on Canvas
	Then text editor is displayed in 'TextEditorPopup' container
	When User presses the 'Home' key on the keyboard
	...
	When User drag and drop color point through color Area by '280' '-220' coordinates
	...
	When User clicks 'Apply' button in Color Picker window
	Then 'Text' topic text color is changed on 'Text Formatting' Topic
	When User clicks by coordinates '200' and '50' on Canvas
	Then 'Text' topic text color is changed on 'Text Formatting' Topic

@MindManager @EditingCapabilities @TextStyleSettings @App_QA @App_Staging @App_Prod @Cleanup @Qase[WEB-270] @Upd_Qase
Scenario: Check_that_color_can_be_applied_to_part_of_topic_text_by_clicking_on_color_Slider
	When User remembers 'Text Formatting' topic model id and name
	When User remembers 'Text' text color in 'Text Formatting' topic on Canvas
	When User clicks 'Text Formatting' topic on Canvas
	When User clicks on text in the 'Text Formatting' topic on Canvas
...
@MindManager @EditingCapabilities @TextStyleSettings @App_QA @App_Staging @App_Prod @Cleanup @Qase[WEB-270] @Upd_Qase
Scenario: Check_that_color_can_be_applied_to_part_of_topic_text_by_chosen_color_in_palette_on_color_picker
	When User remembers 'Text Formatting' topic model id and name
	When User clicks 'Text Formatting' topic on Canvas
	When User clicks on 'Font format' option in Floating Toolbar Popup
	When User clicks Color button in text editor in 'TextEditorPopup' container
	...
	When User clicks 'Apply' button in Color Picker window
	Then text 'Text' has 'rgba(27, 255, 0, 1)' color in the 'Text Formatting' topic on Canvas

@MindManager @EditingCapabilities @TextStyleSettings @App_Staging @App_Prod @Cleanup @Qase[WEB-270] @Upd_Qase
Scenario: Check_that_color_can_be_applied_to_part_of_topic_text_by_eyedropper_tool
	When User remembers 'Text Formatting' topic model id and name
	When User clicks 'Text Formatting' topic on Canvas
	When User clicks on text in the 'Text Formatting' topic on Canvas
	Then text editor is displayed in 'TextEditorPopup' container
	...
	When User clicks 'Apply' button in Color Picker window
	Then text 'Text' has 'rgba(236, 244, 250, 1)' color in the 'Text Formatting' topic on Canvas

@MindManager @EditingCapabilities @TextStyleSettings @App_QA @App_Staging @App_Prod @Cleanup @Qase[WEB-271] @Upd_Qase
Scenario: Check_that_Bold_font_style_can_be_applied_to_all_of_topic_text
	When User clicks 'Text Formatting' topic on Canvas
	When User clicks on text in the 'Text Formatting' topic on Canvas
	Then text editor is displayed in 'TextEditorPopup' container
	When User presses the Ctrl_A combination key on the keyboard
...
@MindManager @EditingCapabilities @TextStyleSettings @App_QA @App_Staging @App_Prod @Cleanup @Qase[WEB-271] @Upd_Qase
Scenario: Check_that_Bold_font_style_can_be_applied_to_part_of_topic_text
	When User remembers 'Text Formatting' topic model id and name
	When User clicks 'Text Formatting' topic on Canvas
	When User clicks on text in the 'Text Formatting' topic on Canvas
	Then text editor is displayed in 'TextEditorPopup' container
	...
	When User clicks 'bold' button in font style section of text editor in 'TextEditorPopup' container
	Then 'bold' button is selected in font style section of text editor in 'TextEditorPopup' container
	Then text 'Text' is displayed 'bold' style in the 'Text Formatting' topic on Canvas
	When User clicks by coordinates '200' and '50' on Canvas
	Then text 'Text' is displayed 'bold' style in the 'Text Formatting' topic on Canvas
	Then text 'Formatting' is displayed 'none' style in the 'Text Formatting' topic on Canvas

@MindManager @EditingCapabilities @TextStyleSettings @App_QA @App_Staging @App_Prod @Cleanup @Qase[WEB-271] @Upd_Qase
Scenario: Check_that_Bold_font_style_can_be_applied_to_part_of_multiline_topic_text
	When User remembers 'Multiline topic text' topic model id and name
	When User clicks 'Multiline topic text' topic on Canvas
	When User clicks on text in the 'Multiline topic text' topic on Canvas
	Then text editor is displayed in 'TextEditorPopup' container
...
Scenario: Check_that_Bold_font_style_can_be_remove_from_the_topic_text
	...
	When User clicks on text in the 'Bold' topic on Canvas
	When User double clicks to the 'Bold' topic text on Canvas
	Then text editor is displayed in 'TextEditorPopup' container
	Then 'bold' button is selected in font style section of text editor in 'TextEditorPopup' container
	When User clicks 'bold' button in font style section of text editor in 'TextEditorPopup' container
...
@MindManager @EditingCapabilities @TextStyleSettings @App_QA @App_Staging @App_Prod @Cleanup @Qase[WEB-272] @Upd_Qase
Scenario: Check_that_Italic_font_style_can_be_applied_to_part_of_topic_text
	When User remembers 'Text Formatting' topic model id and name
	When User clicks 'Text Formatting' topic on Canvas
	When User clicks on text in the 'Text Formatting' topic on Canvas
	Then text editor is displayed in 'TextEditorPopup' container
	...
	When User clicks 'italic' button in font style section of text editor in 'TextEditorPopup' container
	Then 'italic' button is selected in font style section of text editor in 'TextEditorPopup' container
	Then text 'Text' is displayed 'italic' style in the 'Text Formatting' topic on Canvas
	When User clicks by coordinates '200' and '50' on Canvas
	Then text 'Text' is displayed 'italic' style in the 'Text Formatting' topic on Canvas
	Then text 'Formatting' is displayed 'none' style in the 'Text Formatting' topic on Canvas

@MindManager @EditingCapabilities @TextStyleSettings @App_QA @App_Staging @App_Prod @Cleanup @Qase[WEB-272] @Upd_Qase
Scenario: Check_that_Italic_font_style_can_be_applied_to_part_of_multiline_topic_text
	When User remembers 'Multiline topic text' topic model id and name
	When User clicks 'Multiline topic text' topic on Canvas
	When User clicks on text in the 'Multiline topic text' topic on Canvas
	Then text editor is displayed in 'TextEditorPopup' container
...
Scenario: Check_that_Italic_font_style_can_be_remove_from_the_topic_text
	...
	When User clicks on text in the 'Italic' topic on Canvas
	When User double clicks to the 'Italic' topic text on Canvas
	Then text editor is displayed in 'TextEditorPopup' container
	Then 'italic' button is selected in font style section of text editor in 'TextEditorPopup' container
	When User clicks 'italic' button in font style section of text editor in 'TextEditorPopup' container
...
Scenario: Check_that_Underline_font_style_can_be_applied_to_all_of_topic_text
	When User clicks 'Text Formatting' topic on Canvas
...
@MindManager @EditingCapabilities @TextStyleSettings @App_QA @App_Staging @App_Prod @Cleanup @Qase[WEB-273] @Upd_Qase
Scenario: Check_that_Underline_font_style_can_be_applied_to_part_of_topic_text
	When User remembers 'Text Formatting' topic model id and name
	When User clicks 'Text Formatting' topic on Canvas
	When User clicks on text in the 'Text Formatting' topic on Canvas
	Then text editor is displayed in 'TextEditorPopup' container
	...
	When User selects from `0` to '4' the text symbol in 'Text Formatting' topic
	When User clicks 'underline' button in font style section of text editor in 'TextEditorPopup' container
	Then text 'Text' is displayed 'underline' style in the 'Text Formatting' topic on Canvas
	When User clicks by coordinates '200' and '50' on Canvas
	Then text 'Text' is displayed 'underline' style in the 'Text Formatting' topic on Canvas
	Then text 'Formatting' is displayed 'none' style in the 'Text Formatting' topic on Canvas
...
Scenario: Check_that_Strikethrough_font_style_can_be_applied_to_all_of_topic_text
	When User clicks 'Text Formatting' topic on Canvas
	When User clicks on text in the 'Text Formatting' topic on Canvas
	Then text editor is displayed in 'TextEditorPopup' container
	When User presses the Ctrl_A combination key on the keyboard
...
@MindManager @EditingCapabilities @TextStyleSettings @App_QA @App_Staging @App_Prod @Cleanup @Qase[WEB-274] @Upd_Qase
Scenario: Check_that_Strikethrough_font_style_can_be_applied_to_part_of_topic_text
	When User remembers 'Text Formatting' topic model id and name
	When User clicks 'Text Formatting' topic on Canvas
	When User clicks on text in the 'Text Formatting' topic on Canvas
	Then text editor is displayed in 'TextEditorPopup' container
	...
	When User selects from `0` to '4' the text symbol in 'Text Formatting' topic
	When User clicks 'strikethrough' button in font style section of text editor in 'TextEditorPopup' container
	Then text 'Text' is displayed 'strikethrough' style in the 'Text Formatting' topic on Canvas
	When User clicks by coordinates '200' and '50' on Canvas
	Then text 'Text' is displayed 'strikethrough' style in the 'Text Formatting' topic on Canvas
	Then text 'Formatting' is displayed 'none' style in the 'Text Formatting' topic on Canvas
...
@MindManager @EditingCapabilities @TextStyleSettings @App_QA @App_Staging @App_Prod @Cleanup @Qase[WEB-1321] @Upd_Qase
Scenario: Check_that_Font_Size_can_be_applied_to_part_of_topic_text_via_arrow_button
	When User remembers 'Text Formatting' topic model id and name
	When User clicks 'Text Formatting' topic on Canvas
	When User clicks on text in the 'Text Formatting' topic on Canvas
	Then text editor is displayed in 'TextEditorPopup' container
	...
	Then text 'Text' has font size of '18' in the 'Text Formatting' topic on Canvas
	Then text 'Formatting' has font size of '16' in the 'Text Formatting' topic on Canvas
...
Scenario: Check_that_Font_Size_can_be_applied_all_of_topic_text_via_arrow_button
	When User clicks 'Text Formatting' topic on Canvas
	When User clicks on text in the 'Text Formatting' topic on Canvas
	Then text editor is displayed in 'TextEditorPopup' container
	When User presses the Ctrl_A combination key on the keyboard
	When User clicks 'up' arrow in font size section of text editor in 'TextEditorPopup' container
	Then 'Text Formatting' topic text has '18' size
	When User clicks by coordinates '200' and '50' on Canvas
	Then 'Text Formatting' topic text has '18' size
	When User clicks 'Text Formatting' topic on Canvas
	When User clicks on text in the 'Text Formatting' topic on Canvas
