@retry(2)
Feature: DefaultStyleForAllUsers
Check Toolbar Default Style Styles for all users 
...
@MindManager @Toolbar @ToolbarDefaultStyle @App_QA @App_Staging @App_Prod @Cleanup @Qase[WEB-1378] @Upd_Qase
Scenario: To_verify_that_user_can_set_the__floating_topics_default_attributes_style_for_all_users
...
@MindManager @Toolbar @ToolbarDefaultStyle @App_QA @App_Staging @App_Prod @Cleanup @Qase[WEB-1442] @Upd_Qase
Scenario: To_verify_that_user_can_set_main_topics_default_attributes_for_all_users
...
@MindManager @Toolbar @ToolbarDefaultStyle @App_QA @App_Staging @App_Prod @Cleanup @Qase[WEB-1443] @Upd_Qase
Scenario: To_verify_that_user_can_set_subtopic_topics_default_attributes_for_all_users
...
@MindManager @Toolbar @ToolbarDefaultStyle @App_QA @App_Staging @App_Prod @Cleanup @Qase[WEB-1444] @Upd_Qase
Scenario: To_verify_that_user_can_set_the_default_callout_topics_attributes_for_all_users
...
@MindManager @Toolbar @ToolbarDefaultStyle @App_QA @App_Staging @App_Prod @Cleanup @Qase[WEB-1448] @Upd_Qase @JIRA[MMCV-10329]
Scenario: Check_that_User_can_set_relationship_default_attribute_for_all_users
...
@MindManager @Toolbar @ToolbarDefaultStyle @App_QA @App_Staging @App_Prod @Cleanup @Qase[WEB-1445] @Upd_Qase @JIRA[MMCV-9960]
Scenario: Check_that_User_can_reset_relationship_label_default_attribute_for_all_users
	When User clicks 'ImageTopic1' topic on Canvas
	When User clicks Add relationship button on the Toolbar
	Then cursor relationship added to the 'ImageTopic1' topic on Canvas
	When User clicks 'Central Topic' topic on Canvas
...
@MindManager @Toolbar @ToolbarDefaultStyle @App_QA @App_Staging @App_Prod @Cleanup @Qase[WEB-1449] @Upd_Qase @JIRA[MMCV-9960]
Scenario: Check_that_User_can_set_boundaries_default_attribute_for_all_users
	When User clicks 'Main Topic' topic on Canvas
