@retry(2)
Feature: MessageOnCliclingOnUnavailableFeaturesMac
To verify Upsell dialog for unavailable features

@MindManager @UpSellDialog @UpSellDialogMac @MessageOnCliclingOnUnavailableFeatures @Not_Run_Firefox @Mac_browser @App_QA @App_Staging @App_Prod @Cleanup @Qase[WEB-2898] @Upd_Qase
...
@MindManager @UpSellDialog @UpSellDialogMac @MessageOnCliclingOnUnavailableFeatures @Not_Run_Firefox @Mac_browser @App_QA @App_Staging @App_Prod @Cleanup @Qase[WEB-2901] @Upd_Qase
Scenario: Verify_that_it_is_possible_to_close_advertising_dialog_via_Close_button
	...
	Then following buttons are displayed in 'advanced' menu
		...
		| Map Roll-up      |
		| Manage Resources |
	When User clicks button with 'Manage Resources' name in 'advanced' menu
	Then 'upsell-dialog' dialog is displayed to User
	When User clicks 'Close' button in 'upsell-dialog' dialog
	Then 'upsell-dialog' dialog is not displayed to User


@MindManager @UpSellDialog @UpSellDialogMac @MessageOnCliclingOnUnavailableFeatures @Not_Run_Firefox @Mac_browser @App_QA @App_Staging @App_Prod @Cleanup @Qase[WEB-2891] @Upd_Qase
...
@MindManager @UpSellDialog @UpSellDialogMac @MessageOnCliclingOnUnavailableFeatures @Not_Run_Firefox @Mac_browser @App_QA @App_Staging @App_Prod @Cleanup @Qase[WEB-2894] @Upd_Qase
Scenario: Verify_that_tooltip_is_displayed_on_hovering_over_Diamond_icon_for_user_with_essentials_license
	...
	When User clicks menu button with 'advanced' name in 'ToolbarPageElement' container
	Then 'advanced' Menu is displayed to User
	When User mouse hovers Diamond icon on 'Map Roll-up' button in 'advanced' menu
	Then 'Upgrade to unlock this feature' tooltip is displayed to the User

@MindManager @UpSellDialog @UpSellDialogMac @MessageOnCliclingOnUnavailableFeatures @Not_Run_Firefox @Mac_browser @App_QA @App_Staging @App_Prod @Cleanup @Qase[WEB-2895] @Upd_Qase
Scenario: Verify_that_tooltip_is_displayed_on_hovering_over_Diamond_icon_for_user_with_subscription_license
	...
	Then following buttons are displayed in 'advanced' menu
		...
		| Map Roll-up      |
		| Manage Resources |
	When User mouse hovers Diamond icon on 'SmartRules' button in 'advanced' menu
...
Scenario: Verify_that_tooltip_is_displayed_on_hovering_over_Diamond_icon_for_user_with_trial_license
	...
	Then following buttons are displayed in 'advanced' menu
		...
		| Map Roll-up      |
		| Manage Resources |
	When User mouse hovers Diamond icon on 'Auto Calculation' button in 'advanced' menu
	Then 'Available in MindManager Desktop' tooltip is displayed to the User