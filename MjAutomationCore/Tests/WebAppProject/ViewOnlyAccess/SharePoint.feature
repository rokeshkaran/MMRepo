@retry(2)
Feature: SharePoint
Check View-only map UI for SharePoint Files
...
Background: Pre-condition
	...
	When User '2' login to SharePoint cloud
...
@MindManager @ViewOnlyAccess @SharePoint @App_QA @App_Staging @App_Prod @Qase[WEB-2781] @Cleanup @Upd_Qase @Build_24.1.104
Scenario: View_only_map_UI_position_of_top_menu_SharePoint
...
@MindManager @ViewOnlyAccess @SharePoint @App_QA @App_Staging @App_Prod @Qase[WEB-2781,WEB-2788] @Cleanup @JIRA[MMCV-10445] @Upd_Qase @Build_24.1.104
Scenario: View_only_map_UI_Top_menu_buttons_SharePoint
	Then menu button with 'file' name is displayed in 'status-read-only' state on Overlay panel
	Then Menu toolbar is displayed to Standard mode in 'top' side on page
...
@MindManager @ViewOnlyAccess @Co_Editing @SharePoint @App_QA @App_Staging @App_Prod @Qase[WEB-2781] @Cleanup @Upd_Qase @Build_24.1.104
Scenario: View_only_map_UI_Top_menu_buttons_SharePoint_in_coedit_session
...
@MindManager @ViewOnlyAccess @SharePoint @App_QA @App_Staging @App_Prod @Qase[WEB-2782] @Cleanup @Upd_Qase @Build_24.1.104
Scenario: Check_enabled_features_in_view_only_map_in_SharePoint
...
@MindManager @ViewOnlyAccess @SharePoint @App_QA @App_Staging @App_Prod @Qase[WEB-2782] @Cleanup @Upd_Qase @Build_24.1.104
Scenario: Check_zoom_feature_in_view_only_map_in_SharePoint
...
@MindManager @ViewOnlyAccess @SharePoint @App_QA @App_Staging @App_Prod @Qase[WEB-2783] @Snap_Cleanup @Cleanup @JIRA[MMCV-10450] @Upd_Qase @Build_24.1.104
Scenario: Check_Snap_feature_in_viewonly_mode_in_SharePoint
...
@MindManager @ViewOnlyAccess @SharePoint @App_QA @App_Staging @App_Prod @Qase[WEB-2783] @Cleanup @Upd_Qase @Build_24.1.104
Scenario: Check_comment_feature_in_viewonly_mode_in_SharePoint
...
@MindManager @ViewOnlyAccess @SharePoint @App_QA @App_Staging @App_Prod @Qase[WEB-2783] @Cleanup @JIRA[MMCV-10452] @Upd_Qase @Build_24.1.104
Scenario: Check_Notes_feature_in_viewonly_mode_in_SharePoint
...
@MindManager @ViewOnlyAccess @SharePoint @App_QA @App_Staging @App_Prod @Qase[WEB-2784] @Cleanup @JIRA[MMCV-10452] @Upd_Qase @Build_24.1.104
Scenario: Check_Property_feature_in_viewonly_mode_in_SharePoint
...
@MindManager @ViewOnlyAccess @SharePoint @App_QA @App_Staging @App_Prod @Qase[WEB-2785,WEB-2790] @Cleanup @Upd_Qase @Build_24.1.104
Scenario: Check_that_disabled_features_arу_not_accessible_to_a_view_only_user_in_SharePoint
	When User clicks 'Topic A' topic on Canvas
...
@MindManager @ViewOnlyAccess @SharePoint @App_QA @App_Staging @App_Prod @Qase[WEB-2785] @Cleanup @Upd_Qase @Build_24.1.104
Scenario: Check_that_Snap_feature_is_not_available_in_topic_context_menu_to_a_view_only_user_in_SharePoint
...
@MindManager @ViewOnlyAccess @SharePoint @App_QA @App_Staging @App_Prod @Qase[WEB-2785] @Cleanup @Upd_Qase @Build_24.1.104
Scenario: Check_icon_context_menu_to_a_view_only_user_in_SharePoint
...
@MindManager @ViewOnlyAccess @SharePoint @App_QA @App_Staging @App_Prod @Qase[WEB-2785] @Cleanup @JIRA[MMCV-10465] @Upd_Qase @Build_24.1.104
Scenario: Check_topic_context_menu_to_a_view_only_user_in_SharePoint
	When User Right clicks on 'CT' topic
	Then following menu buttons are displayed in 'topic-contextmenu' menu
		| items                     |
		| Advanced topic formatting |
...
@MindManager @ViewOnlyAccess @SharePoint @App_QA @App_Staging @App_Prod @Qase[WEB-2785] @Cleanup @JIRA[MMCV-10466] @Upd_Qase @Build_24.1.104
Scenario: Check_that_Staking_order_is_not_availabel_in_topic_context_menu_to_a_view_only_user_in_SharePoint
...
@MindManager @ViewOnlyAccess @SharePoint @App_QA @App_Staging @App_Prod @Qase[WEB-2786] @Cleanup @Upd_Qase @Build_24.1.104
Scenario: Check_that_the_File_menu_options_are_limited_for_a_view_only_user_in_SharePoint
...
@MindManager @ViewOnlyAccess @SharePoint @App_QA @App_Staging @App_Prod @Qase[WEB-2787] @Cleanup @Upd_Qase @Build_24.1.104
Scenario: Check_that_the_Help_menu_options_are_limited_for_a_view_only_user_in_SharePoint
...
@MindManager @ViewOnlyAccess @SharePoint @App_QA @App_Staging @App_Prod @Qase[WEB-2789] @Cleanup @Upd_Qase @Build_24.1.104
Scenario: Check_Search_for_a_view_only_user_in_SharePoint
...
@MindManager @ViewOnlyAccess @SharePoint @App_QA @App_Staging @App_Prod @Qase[WEB-2790] @Cleanup @JIRA[MMCV-10458] @Upd_Qase @Build_24.1.104
Scenario: Check_that_disabled_toolbar_are_visually_indicated_as_such_for_a_view_only_user_in_SharePoint
	Then Menu toolbar is displayed to Standard mode in 'top' side on page
...
@MindManager @ViewOnlyAccess @SharePoint @App_QA @App_Staging @App_Prod @Qase[WEB-2790] @Cleanup @Upd_Qase @Build_24.1.104
Scenario: Check_that_disabled_sidepane_are_visually_indicated_as_such_for_a_view_only_user_in_SharePoint
	Given User uploads following files to 'Shared Documents/For QA automation/RuntimeDataFiles' folder of SharePoint cloud via Api
		| fileName              | FilePath       |
